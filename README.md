...
Plot is visualize in `selectivity_plot.ipynb`

## How to run?

You need at least one GPU.

```bash
python -u trainer.py  --arch=resnet20  --evaluate --resume=./pretrained_models/resnet20.th
```

This branch is forked from https://github.com/akamaster/pytorch_resnet_cifar10 Below is the original Readme. 
